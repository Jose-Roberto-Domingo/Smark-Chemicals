...
<script>
    function confirmarEliminar(id) {
        ...
        if (confirmacion) {
            window.location.href = "<?= base_url('index.php/Admin/compras/delete/'); ?>" + id;
        }
    }
</script>
                ...
                <table class="table2">
                    ...
                    <?php foreach($compras as $compra):?>
                            <tr>
                                ...
                                <td>
                                <a class="btn btn-danger" role="button" onclick="confirmarEliminar(<?= $compra->idCompra ?>)"><i class="bi bi-trash3"></i></a>
                                    <a class="btn btn-warning" role="button" href="<?= base_url('index.php/Admin/compras/editar/'. $compra->idCompra); ?>"><i class="bi bi-pencil-square"></i></a>
                                </td>
                            </tr>
                            <?php endforeach?>
                    </tbody>
