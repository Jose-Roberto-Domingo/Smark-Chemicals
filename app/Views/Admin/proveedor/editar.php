...
<div class="container">
    ...
    <?php
        ...
        <center><h2>Editar Proveedor</h2></center>
            <form action="<?= base_url('Admin/proveedor/update'); ?>" method="POST">
            <?= csrf_field() ?>
            <input type="hidden" name="idProveedor" value="<?= $proveedores->idProveedor ?>">
                <div class="mb-3">
                    <label for="nombreEmpresa" class="form-label">Nombre de la Empresa</label>
                    <input type="text" minlength="3" maxlength="50" class="form-control" name="nombreEmpresa" id="nombreEmpresa" value="<?= $proveedores->nombreEmpresa?>" required="required">
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" minlength="3" maxlength="50" class="form-control" name="direccion" id="direccion" value="<?= $proveedores->direccion?>" required="required">
                </div>
